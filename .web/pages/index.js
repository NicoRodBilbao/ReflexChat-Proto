...
import { Box as RadixThemesBox, Button as RadixThemesButton, Container as RadixThemesContainer, Flex as RadixThemesFlex, Select as RadixThemesSelect, Text as RadixThemesText, TextField as RadixThemesTextField } from "@radix-ui/themes"
...
export function Errorboundary_0e5e0ddfeb56c4b6271648b0d1615f85 () {
...
<RadixThemesContainer css={({ ["padding"] : "16px", ["alignItems"] : "center", ["backgroundColor"] : "rgba(17, 17, 19)", ["minHeight"] : "100vh", ["paddingBottom"] : "5em" })} size={"3"}>

<Script className={"css-2x5x1l"} data-nscript={"afterInteractive"} strategy={"afterInteractive"}>

{"\n        (function(){function scrollToBottom() {\n            console.log('Scrolling to bottom...');\n            window.scrollTo(0, document.body.scrollHeight);\n        }})\n        "}
</Script>
<RadixThemesBox css={({ ["position"] : "fixed", ["left"] : "0", ["top"] : "0", ["height"] : "100%", ["width"] : "15%", ["backgroundColor"] : "rgba(30, 30, 30, 0.9)", ["padding"] : "1em", ["boxShadow"] : "2px 0 5px rgba(0, 0, 0, 0.5)", ["zIndex"] : "1000" })}>

<Select__root_763780e347a8f8103da9712d90618821/>
</RadixThemesBox>
<Box_839359393df4c5962567a6967f7b5c08/>
<RadixThemesBox css={({ ["position"] : "fixed", ["bottom"] : "0", ["width"] : "100%", ["height"] : "12%", ["display"] : "flex", ["left"] : "50%", ["transform"] : "translateX(-50%)", ["justifyContent"] : "center", ["padding"] : "1em", ["backgroundColor"] : "rgba(17, 17, 19)" })}>
...
<Debounceinput_9326786911e392350cedfb79bbbdc0d6/>
...
export function Select__root_763780e347a8f8103da9712d90618821 () {
  ...
  const on_change_fc3b6243221522b01da373e9c51fceb4 = useCallback(((_ev_0) => (addEvents([(Event("reflex___state____state.reflex_chat___state____state.change_selection", ({ ["selected_value"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, Event])


  return (
    <RadixThemesSelect.Root onValueChange={on_change_fc3b6243221522b01da373e9c51fceb4} value={reflex___state____state__reflex_chat___state____state.selected_value}>
...
{""}
<RadixThemesSelect.Item value={"apple"}>

{"apple"}
</RadixThemesSelect.Item>
<RadixThemesSelect.Item value={"grape"}>

{"grape"}
</RadixThemesSelect.Item>
<RadixThemesSelect.Item value={"pear"}>
...
export function Box_839359393df4c5962567a6967f7b5c08 () {
  const reflex___state____state__reflex_chat___state____state = useContext(StateContexts.reflex___state____state__reflex_chat___state____state)
...
<>{reflex___state____state__reflex_chat___state____state.chat_history.map((messages, index_2582efff18ac2714) => (
  <RadixThemesBox key={index_2582efff18ac2714}>
...
export function Debounceinput_9326786911e392350cedfb79bbbdc0d6 () {
  const reflex___state____state__reflex_chat___state____state = useContext(StateContexts.reflex___state____state__reflex_chat___state____state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    <DebounceInput css={({ ["borderWidth"] : "1px", ["padding"] : "0.5em", ["boxShadow"] : "rgba(0, 0, 0, 0.15) 0px 2px 8px", ["width"] : "60%", ["backgroundColor"] : "rgba(255, 255, 255, 0.1)", ["color"] : "white" })} debounceTimeout={300} element={RadixThemesTextField.Root} onChange={on_change_6bdb4b933715c7635c2a386abbdf8ece} onKeyDown={on_key_down_87dd593360b21caf06f9e9e3a676f2ec} placeholder={"Type your message here..."} value={reflex___state____state__reflex_chat___state____state.question}/>
  )
}
...
export default function Component() {
  ...
  return (
    <Errorboundary_0e5e0ddfeb56c4b6271648b0d1615f85/>
  )
}
